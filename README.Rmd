...
## basic example code
```
This command will write a datafile into the directory called CPM_raw_data_UL.csv with the model indicator names replaced by default indicator names and as the notes attribute is set to 1 it will also generate a file to add conversion factors and notes for the indicators.
